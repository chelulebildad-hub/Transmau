...
export default function Home() {
  return (
    <>
     <SEO
  title="Certified Fruit Seedlings, Pure Honey & Bee Products"
  description="Trans Mau Farms supplies certified disease-free avocado, apple, citrus and grape seedlings, pure natural honey, bee pollen, beeswax, orchard establishment services and farmer training in Olenguruone, Nakuru County, Kenya."
  url="/"
  image="/images/crop-rows-field.jpeg"
/>
      <Hero />
      <Marquee />
      <IntroStrip />
